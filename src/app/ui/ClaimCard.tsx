...
const ClaimCard: React.FC<ClaimCardProps> = ({status, address, justClaimed, balanceEarned, referrerEarned}) => {
    return (
        <div className="w-full border-t-[3px] border-gray-200 px-3 lg:px-5 py-4">
            {/* Mobile view - scrollable */}
            <div className="overflow-x-auto scrollbar-hide md:hidden">
                <div className="flex items-center gap-4 min-w-max">
                    <div className={`${status === "confirmed" ? "bg-[#DCFCE7]" : "bg-[#FEF9C3]"} w-[120px] flex items-center justify-between px-2 py-1.5 rounded-full flex-shrink-0`}>
                    ...
                    <img loading="lazy" src="three-dots.png" alt="three-dots-icon" className="flex-shrink-0" />
                </div>
            </div>
            
            {/* Tablet/Desktop view - normal layout */}
